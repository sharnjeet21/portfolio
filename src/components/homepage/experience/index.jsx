    ...
    <section id="experience" className="relative z-50  my-12 lg:my-24">
      <div className="sticky top-10">
        ...
        <div className="flex items-center gap-4">
          <code className="bg-[#2F2F2F] text-white px-5 py-3 text-xl rounded-md font-mono tracking-wide">
            Experience
          </code>
          <span className="flex-grow h-[2px] bg-[#2F2F2F]"></span>
        </div>
      </div>
      ...
      <div className="pt-24">
        <div className="flex flex-col gap-6">
          {experiences.slice(0, 4).map((experience, index) => (
            ...
            >
              <a href={experience.link} target="_blank" rel="noopener noreferrer" className="block w-full">
