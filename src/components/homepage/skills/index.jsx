...
import pythonIcon from "../../../assets/svg/skills/python.svg";
import mysqlIcon from "../../../assets/svg/skills/mysql.svg";
import dockerIcon from "../../../assets/svg/skills/docker.svg";
...
import cIcon from "../../../assets/svg/skills/c.svg";
import cppIcon from "../../../assets/svg/skills/cplusplus.svg";
              ...
              <div className="h-full w-full rounded-lg border border-[#1f223c] bg-[#2F2F2F] shadow-none shadow-gray-50 group-hover:border-violet-500 transition-all duration-500">
                ...
                <div className="flex flex-col items-center justify-center gap-3 p-6">
                  <div className="h-8 sm:h-10">
                    {console.log("Skill:", skill, "Image:", skillIcons[skill])}
                    <img
                      src={skillIcons[skill] || "/fallback.png"}
                      alt={skill}
                      title={skill}
                      width={40}
                      height={40}
