                ...
                <div className="flex flex-col items-center justify-center gap-3 p-6">
                  <div className="h-10 w-10 flex items-center justify-center">
                    {skillsImage(skill) ? (
                      ...
                      <div className="h-10 w-10 rounded-lg border border-violet-500/40 bg-violet-500/10 flex items-center justify-center text-sm font-semibold text-violet-200">
                        {skill
                          .split(" ")
                          .map((word) => word[0])
                          .join("")
                  ...
                  <p className="text-white text-sm sm:text-lg text-center">{skill}</p>
                </div>
              </div>
            </div>
          ))}
